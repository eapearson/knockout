/*!
 * Knockout JavaScript library v3.5.1-beta1
...
/*global ko, DEBUG, jQueryInstance*/
(function (ko) {
    'use strict';
    function utils() {
    ...
    console.log('utils?', utils.createSymbolOrString);
...
(function (ko) {
    ...
    ko.bindingHandlers['class'] = {
        'update': function (element, valueAccessor) {
            // TODO: use standard DOM api
            const value = ko.utils.stringTrim(ko.utils.unwrapObservable(valueAccessor()));
    ...
    ko.bindingHandlers['template'] = {
        'init': function (element, valueAccessor) {
            ...
            if (typeof bindingValue == 'string' || bindingValue['name']) {
                ...
                container = nodes[0] && nodes[0].parentNode;
