...
describe('Binding: With', function () {
    ...
    describe('With "noChildContext = false" and "as"', function () {
        ...
        it('Should remove nodes when an observable value become falsy', function () {
            ...
            // const childNodeCount = parseInt(String(testNode.childNodes[0].childNodes.length));
            expect(testNode.childNodes[0].childNodes.length === 1).toBeTruthy();
            // this may just be wrong...
            const nodeText = testNode.childNodes[0].childNodes.item(0).innerText;
            expect(nodeText).toEqual('Child prop value');
            // expect(testNode.childNodes[0].childNodes.item(0)).toContainText('Child prop value');
